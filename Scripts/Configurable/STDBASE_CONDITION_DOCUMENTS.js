/*
Title : Condition Documents
Purpose : A function is required to dynamically handle required documents.  This script should be able to work with both Conditional Documents and the standard document uploads (displays a message indicated documents not attached).
 ...
 JSON Example : 
 {
  "Building/Commercial/abc/xyz": {
    "Pageflow": [
      {
        "metadata": {
          "description": "Documents are Required",
          "operators": {
