	    ...
	    for (r in rules) {
	        ...
	        if (createNewRecordRules) {
	            for (nr in createNewRecordRules) {
	                ...
	                copyFailChecklistItemsToNewRecord(capId, inspId, newRecordType, newInspectionType, newInspectionStatus, newInspectionDaysOut, currentUserID, carryOverFailedItems, failedChecklistType, violationReferralRules, newRecordStatus);
...
function copyFailChecklistItemsToNewRecord(srcCapId, srcInspId, targetRecordType, targetInspType, targetInspStatus, targetInspDaysOut, inspectorId, carryOverFailedItems, failedChecklistType, violationReferralRules, newRecordStatus) {
